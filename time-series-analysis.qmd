...
The notebook and modeling PDF have been linked below, but are not in this report, due to its sheer length. However, they are linked below in order to show the modeling code, extra data visualization of initial data and modeling, and other interesting findings:
