...
As a supplement to our analysis of mean monthly song popularity, we decided to do an analysis of the predictors of individual song popularity, given the potential usefulness of this kind of model for music-industry professionals. We used Python instead of R for this supplementary analysis. After conducting a  more detailed exploratory data  analysis that included outlier detection and an investigation of the interaction between time period and each predictor, we fit a simple regression model, a regression model with interactions that account for the temporally varying nature of the data, and a neural network and compared the three models.
