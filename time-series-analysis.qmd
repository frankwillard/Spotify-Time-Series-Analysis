...
spotify_data %>%
  ...
  ggplot(aes(x = year, y = meanpop, color = hasmonth)) + geom_line() + 
  labs(title = "Yearly time series of data with and without monthly granularity",
       color = "Has month?",
       x = "Year",
...
grid.arrange(acousticness_bveda, liveness_bveda, duration_bveda, nrow = 2)

grid.arrange(explicitness_bveda, speechiness_bveda, tempo_bveda, nrow = 2)
```
